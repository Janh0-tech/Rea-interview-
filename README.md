...
### What you'll find in this repository
  ...
  - Handling forms, radio buttons, dropdowns
  - useState, useEffect, useReducer, useRef
  - Debouncing and optimization (useMemo, useCallback)
  - Controlled & uncontrolled components
  - api data fetching
  - Context api and prop-types
  - custom hooks
  - error boundaries
  - pagination and portals
  - common react interview patterns
